...
const __venc_ModalButton = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_ModalButton = p => "type=" + __venc_ModalButton(p.type) + '|' + "destructive=" + __venc_ModalButton(p.destructive);
...
const __venc_ModalHeader = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_ModalHeader = p => "type=" + __venc_ModalHeader(p.type);
...
const __venc_Modal = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_Modal = p => "type=" + __venc_Modal(p.type) + '|' + "size=" + __venc_Modal(p.size) + '|' + "destructive=" + __venc_Modal(p.destructive);
