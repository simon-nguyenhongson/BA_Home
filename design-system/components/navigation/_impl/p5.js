...
const __venc_Catetree = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_Catetree = p => "single=" + __venc_Catetree(p.single);
...
const __venc_CarouselSlick = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_CarouselSlick = p => "state=" + __venc_CarouselSlick(p.state);
...
const __venc_Illustration = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_Illustration = p => "style2=" + __venc_Illustration(p.style2) + '|' + "color=" + __venc_Illustration(p.color) + '|' + "size=" + __venc_Illustration(p.size);
...
const __venc_NoData = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_NoData = p => "type=" + __venc_NoData(p.type) + '|' + "breakpoint=" + __venc_NoData(p.breakpoint);
...
export {
  ...
  __vkey_Catetree,
  Catetree,
  __venc_CarouselSlick,
  __vkey_CarouselSlick,
  CarouselSlick,
  IconLocked,
  __venc_Illustration,
  __vkey_Illustration,
