...
const __venc_CellBodyNormal = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_CellBodyNormal = p => "state=" + __venc_CellBodyNormal(p.state) + '|' + "type=" + __venc_CellBodyNormal(p.type) + '|' + "compressed=" + __venc_CellBodyNormal(p.compressed);
...
const __vkey_InputField = p => "size=" + __venc_InputField(p.size) + '|' + "type=" + __venc_InputField(p.type) + '|' + "destructive=" + __venc_InputField(p.destructive) + '|' + "state=" + __venc_InputField(p.state);

export {
  Toggle,
  __venc_CellBodyNormal,
  __vkey_CellBodyNormal,
  CellBodyNormal,
  IconArrowLeft,
  IconCloseFilled,
  __venc_InputField,
