...
const __venc_CellTitle = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_CellTitle = p => "type=" + __venc_CellTitle(p.type) + '|' + "compressed=" + __venc_CellTitle(p.compressed) + '|' + "error=" + __venc_CellTitle(p.error) + '|' + "filter=" + __venc_CellTitle(p.filter) + '|' + "editColumn=" + __venc_CellTitle(p.editColumn);
