...
const __venc_PaginationNoCount = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_PaginationNoCount = p => "hada=" + __venc_PaginationNoCount(p.hada) + '|' + "state=" + __venc_PaginationNoCount(p.state);
...
const __venc_Description = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_Description = p => "collum=" + __venc_Description(p.collum) + '|' + "line=" + __venc_Description(p.line);
...
export {
  InputField,
  __venc_PaginationNoCount,
  __vkey_PaginationNoCount,
  PaginationNoCount,
  __venc_Description,
  __vkey_Description,
  Description
