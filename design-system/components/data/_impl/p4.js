...
const __venc_InputTextToLabel = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_InputTextToLabel = p => "type=" + __venc_InputTextToLabel(p.type) + '|' + "destructive=" + __venc_InputTextToLabel(p.destructive) + '|' + "state=" + __venc_InputTextToLabel(p.state);
...
const __venc_MetricChange = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_MetricChange = p => "trend=" + __venc_MetricChange(p.trend);
...
const __venc_NumberInput = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_NumberInput = p => "type=" + __venc_NumberInput(p.type) + '|' + "state=" + __venc_NumberInput(p.state) + '|' + "destructive=" + __venc_NumberInput(p.destructive);
...
export {
  ...
  IconSave,
  IconTime,
  __venc_InputTextToLabel,
  __vkey_InputTextToLabel,
  InputTextToLabel,
  __venc_MetricChange,
  __vkey_MetricChange,
  MetricChange,
