...
const __venc_DateMonthYearItem = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_DateMonthYearItem = p => "selected=" + __venc_DateMonthYearItem(p.selected) + '|' + "hovered=" + __venc_DateMonthYearItem(p.hovered) + '|' + "single=" + __venc_DateMonthYearItem(p.single) + '|' + "type=" + __venc_DateMonthYearItem(p.type);
