...
const __venc_ProgressBar = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_ProgressBar = p => "progress=" + __venc_ProgressBar(p.progress) + '|' + "label=" + __venc_ProgressBar(p.label);
