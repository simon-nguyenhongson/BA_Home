...
const __venc_IconWrapper = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_IconWrapper = p => "size=" + __venc_IconWrapper(p.size) + '|' + "union=" + __venc_IconWrapper(p.union);
...
const __venc_Button3 = v => String(v).replace(/[%|=]/g, encodeURIComponent);

const __vkey_Button3 = p => "type=" + __venc_Button3(p.type) + '|' + "shape=" + __venc_Button3(p.shape) + '|' + "size=" + __venc_Button3(p.size) + '|' + "state=" + __venc_Button3(p.state) + '|' + "danger=" + __venc_Button3(p.danger) + '|' + "ghost=" + __venc_Button3(p.ghost);
