// Components bundle — part 1 of 5. Load the parts in order as plain
...
// Components bundle — 71 component(s) materialized from a .fig as one
...
// figma node: 116:30833 LayoutBlocks/base
function LayoutBlocksBase(_p = {}) {
  const props = _p;
...
var __venc_Button = v => String(v).replace(/[%|=]/g, encodeURIComponent);

var __vkey_Button = p => "size=" + __venc_Button(p.size) + '|' + "hierarchy=" + __venc_Button(p.hierarchy) + '|' + "icon=" + __venc_Button(p.icon) + '|' + "destructive=" + __venc_Button(p.destructive) + '|' + "state=" + __venc_Button(p.state);
...
// figma node: 76:19687 Modal button (4 variants)
var __venc_ModalButton = v => String(v).replace(/[%|=]/g, encodeURIComponent);

var __vkey_ModalButton = p => "type=" + __venc_ModalButton(p.type) + '|' + "destructive=" + __venc_ModalButton(p.destructive);

function ModalButton(_p = {}) {
  const props = {
    ..._p,
  ...
  const __impls = {
    // figma: Type=Default, Destructive=False
    "type=default|destructive=false": __body0,
    // figma: Type=Left sub button, Destructive=False
    "type=left sub button|destructive=false": __body1,
    // figma: Type=Default, Destructive=True
    "type=default|destructive=true": __body2,
    // figma: Type=Left sub button, Destructive=True
    "type=left sub button|destructive=true": __body3
  };
  return (__impls[__vkey_ModalButton(props)] ?? __body0)();
}
...
// figma node: 76:19622 Modal header (2 variants)
var __venc_ModalHeader = v => String(v).replace(/[%|=]/g, encodeURIComponent);

var __vkey_ModalHeader = p => "type=" + __venc_ModalHeader(p.type);

function ModalHeader(_p = {}) {
  const props = {
    ..._p,
    xClose: _p.xClose ?? true,
    type: _p.type ?? "sub text",
    paddingBorder: _p.paddingBorder ?? true
  };
  const __body0 = () => /*#__PURE__*/React.createElement("div", {
    className: props.className,
    style: {
  ...
  }, props.text1 ?? "Blog post published"), /*#__PURE__*/React.createElement("span", {
    style: {
      position: "relative",
      fontFamily: "Inter, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
      fontWeight: 400,
  ...
  }, props.text2 ?? "This blog post has been published. Team members will be able to edit this post and republish changes.")), props.xClose && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: 352,
      top: 24,
  ...
  }))), props.paddingBorder && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      height: 16,
      display: "flex",
  ...
  }, props.text1 ?? "Blog post published")), props.xClose && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: 352,
      top: 24,
  ...
  const __impls = {
    // figma: Type=Sub text
    "type=sub text": __body0,
    // figma: Type=Only title
    "type=only title": __body1
  };
  return (__impls[__vkey_ModalHeader(props)] ?? __body0)();
}

// figma node: 76:63427 Modal (6 variants)
var __venc_Modal = v => String(v).replace(/[%|=]/g, encodeURIComponent);

var __vkey_Modal = p => "type=" + __venc_Modal(p.type) + '|' + "size=" + __venc_Modal(p.size) + '|' + "destructive=" + __venc_Modal(p.destructive);

function Modal(_p = {}) {
  const props = {
    ..._p,
    type: _p.type ?? "confirm",
    size: _p.size ?? "default",
    destructive: _p.destructive ?? true
  };
  const __body0 = () => /*#__PURE__*/React.createElement("div", {
    className: props.className,
    style: {
  ...
  const __body1 = () => /*#__PURE__*/React.createElement("div", {
    ...
    text2: "Are you sure you want to delete this post? This action cannot be undone.",
    type: "sub text"
  }), /*#__PURE__*/React.createElement(ModalButton, {
    style: {
      position: "relative",
  ...
  }, /*#__PURE__*/React.createElement(LayoutBlocksBase, {
    style: {
      position: "relative",
      flexGrow: 1,
      alignSelf: "stretch",
  ...
  const __body3 = () => /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderRadius: 8,
      backgroundColor: "rgb(255,255,255)",
      boxShadow: "0px 8px 24px -4px rgba(16,24,40,0.08), 0px 8px 8px -4px rgba(16,24,40,0.03)",
      display: "flex",
      flexDirection: "column",
      alignItems: "flex-start",
      flexWrap: "nowrap",
  ...
  const __impls = {
    // figma: Type=Confirm, Size=Default, Destructive=False
    "type=confirm|size=default|destructive=false": __body0,
    // figma: Type=Confirm, Size=Default, Destructive=True
    "type=confirm|size=default|destructive=true": __body1,
    // figma: Type=Modal content, Size=960, Destructive=False
    "type=modal content|size=960|destructive=false": __body2,
    // figma: Type=Modal content, Size=1140, Destructive=False
    "type=modal content|size=1140|destructive=false": __body3,
    // figma: Type=Modal content, Size=640, Destructive=False
    "type=modal content|size=640|destructive=false": __body4,
    // figma: Type=Modal content, Size=480, Destructive=False
    "type=modal content|size=480|destructive=false": __body5
  };
  return (__impls[__vkey_Modal(props)] ?? __body1)();
}
...
window.LayoutBlocksBase = LayoutBlocksBase;
window.IconAddAlt = IconAddAlt;
window.IconChevronDown = IconChevronDown;
window.Button = Button;
window.ModalButton = ModalButton;
