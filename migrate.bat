...
echo [1] Running migrations V017 - V056...
for %%f in (
  ...
  migrations\V054__ai_skills_fix.sql
  migrations\V055__skills_folder_format.sql
  migrations\V056__archive_legacy_test_cases.sql
) do (
  echo   Running %%f ...
  %PSQL% -f %%f
)
